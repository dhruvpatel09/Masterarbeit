# Milestone: axis-averaged Laplace-clover action-density profile, R/a=4,5,6,7
...
- R/a = 7: dx = 1 and 6, i.e. x_mid = -2.5 and +2.5
...
- R/a = 7: max pull inside source interval = 1.282
...
The R/a=7 result confirms that the double-dip structure persists to the largest separation currently studied. The tau/a=6 heatmaps at large R are visibly noisy, but the axial tau-stability pulls remain below about 1.7 sigma inside the source interval.

## Key files

- results/laplace_clover_R4567_axisavg_advisor_summary.txt
- results/figures/laplace_clover_R4567_tau4_rho_S_axis_profile_midpoint_axisavg_jk_ratio_compare.png
...
- results/figures/laplace_clover_R7tau4_rho_S_heatmap_t0avg48_n100_axisavg_jk_ratio.png
- results/figures/laplace_clover_R7_rho_S_axis_profile_tau4_tau6_t0avg48_n100_axisavg_jk_ratio_compare.png
