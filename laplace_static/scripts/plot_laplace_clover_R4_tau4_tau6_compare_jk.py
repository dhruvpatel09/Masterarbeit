...
s4 = pd.read_csv("results/laplace_clover_probe_R4tau4_plane_t0avg48_n1-100_jk_ratio_summary.csv")
s6 = pd.read_csv("results/laplace_clover_probe_R4tau6_plane_t0avg48_n1-100_jk_ratio_summary.csv")
...
ax.set_title(r"Jackknife ratio: axial $\rho_S$, $R/a=4$, $N_{\rm cfg}=100$")
ax.grid(True, alpha=0.3)
ax.legend()

fig.tight_layout()
out = outdir / "laplace_clover_R4_rho_S_axis_profile_tau4_tau6_t0avg48_n100_jk_ratio_compare.png"
fig.savefig(out, dpi=300)
plt.close(fig)

comp.to_csv("results/laplace_clover_R4_rho_S_axis_tau4_tau6_jk_ratio_compare_t0avg48_n100.csv", index=False)
