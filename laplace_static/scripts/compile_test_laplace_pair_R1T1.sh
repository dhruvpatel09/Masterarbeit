...
rm -f build/test_laplace_pair_R1T1 build/*.o

mpicc ${CFLAGS} -c ${EVECH5}/src/DistEigvecsHdf5Reader.c -o build/DistEigvecsHdf5Reader.o
mpicc ${CFLAGS} -c src/test_laplace_pair_R1T1.c -o build/test_laplace_pair_R1T1.o

mpicxx -o build/test_laplace_pair_R1T1 \
  build/test_laplace_pair_R1T1.o \
...
echo "Built build/test_laplace_pair_R1T1"
ldd build/test_laplace_pair_R1T1 | egrep "not found|hdf5|mpi|mkl|qcd|z" || true
