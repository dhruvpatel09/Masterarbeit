...
if len(sys.argv) != 3:
    raise SystemExit("Usage: analyze_laplace_clover_axisavg_jackknife_ratio_Rtau.py R TAU")
...
out = Path(f"results/laplace_clover_probe_R{R}tau{tau}_axes0-2_t0avg48_n1-100_jk_ratio_summary.csv")
