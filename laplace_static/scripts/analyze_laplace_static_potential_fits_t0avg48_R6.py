...
SUMMARY_OUTPUT = (
    RESULTS /
    "laplace_static_potential_fit_stability_t0avg48_R6.csv"
)

PARAMETER_SAMPLES_OUTPUT = (
    RESULTS /
    "laplace_static_potential_fit_parameters_t0avg48_R6_jackknife.csv"
)

MAIN_CURVE_OUTPUT = (
    RESULTS /
    "laplace_static_potential_cornell_R1-6_t0avg48_curve.csv"
)

MAIN_FIGURE = (
    FIGURES /
    "laplace_static_potential_cornell_R1-6_t0avg48.png"
)

STABILITY_FIGURE = (
    FIGURES /
    "laplace_static_potential_fit_stability_t0avg48_R6.png"
)
