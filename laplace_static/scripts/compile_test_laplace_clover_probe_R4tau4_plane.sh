...
rm -f \
  ...
  build/test_laplace_clover_probe_R4tau4_plane.o \
  build/DistEigvecsHdf5Reader_laplace_clover.o

mpicc ${CFLAGS} -c ${EVECH5}/src/DistEigvecsHdf5Reader.c \
  -o build/DistEigvecsHdf5Reader_laplace_clover.o

mpicc ${CFLAGS} -c src/test_laplace_clover_probe_R4tau4_plane.c \
  -o build/test_laplace_clover_probe_R4tau4_plane.o

mpicxx -o build/test_laplace_clover_probe_R4tau4_plane \
  build/test_laplace_clover_probe_R4tau4_plane.o \
  build/DistEigvecsHdf5Reader_laplace_clover.o \
  ${LDFLAGS} \
  ${H5LDFLAGS} \
...
echo "Built build/test_laplace_clover_probe_R4tau4_plane"
ldd build/test_laplace_clover_probe_R4tau4_plane | egrep "not found|hdf5|mpi|mkl|qcd|z" || true
