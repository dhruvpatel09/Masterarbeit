...
files = [
    ...
    "results/laplace_clover_probe_R4tau6_axis1_t0avg48_n1-100.csv",
    "results/laplace_clover_probe_R4tau6_axis2_t0avg48_n1-100.csv",
]

out = Path("results/laplace_clover_probe_R4tau6_axes0-2_t0avg48_n1-100.csv")
