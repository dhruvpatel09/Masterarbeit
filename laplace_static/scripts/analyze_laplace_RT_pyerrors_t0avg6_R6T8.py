...
INPUT = (
    RESULTS /
    "spatial_avg_RT_R0-6_T1-8_t0avg6_n1-100.csv"
)

JK_FILE = (
    RESULTS /
    "laplace_Veff_R0-6_T1-7_t0avg6_n1-100_jackknife.csv"
)

OUT_L = (
    RESULTS /
    "spatial_avg_RT_R0-6_T1-8_t0avg6_n1-100_pyerrors.csv"
)

OUT_V = (
    RESULTS /
    "laplace_Veff_R0-6_T1-7_t0avg6_n1-100_pyerrors.csv"
)

OUT_CMP = (
    RESULTS /
    "laplace_Veff_R0-6_T1-7_t0avg6_n1-100_error_comparison.csv"
)

ENSEMBLE = "Em1p4_laplace_t0avg6_R6T8"
S_VALUE = 2.0
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(
        FIGDIR / "laplace_ReL_vs_T_pyerrors_t0avg6_R6T8.png",
        dpi=200,
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        FIGDIR / "laplace_Veff_vs_T_pyerrors_t0avg6_R6T8.png",
        dpi=200,
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        FIGDIR / "laplace_Veff_vs_R_pyerrors_t0avg6_R6T8.png",
        dpi=200,
    )
    plt.close()
    ...
    plt.savefig(
        FIGDIR /
        "laplace_Veff_relative_error_pyerrors_t0avg6_R6T8.png",
        dpi=200,
    )
    plt.close()
    ...
    for R in EXPECTED_R[1:]:
        ...
        plt.savefig(
            FIGDIR /
            f"laplace_Veff_pyerrors_zoom_R{R}_t0avg6_R6T8.png",
            dpi=200,
        )
        plt.close()
        ...
        plt.savefig(
            FIGDIR /
            f"laplace_Veff_methods_R{R}_t0avg6_R6T8.png",
            dpi=200,
        )
        plt.close()
