...
inp = Path("results/laplace_clover_probe_R4tau4_axes0-2_t0avg48_n1-100.csv")
out = Path("results/laplace_clover_probe_R4tau4_axes0-2_t0avg48_n1-100_jk_ratio_summary.csv")

df = pd.read_csv(inp)

# Average axes inside each configuration first.
axisavg = (
