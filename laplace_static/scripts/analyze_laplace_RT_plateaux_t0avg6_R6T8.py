...
WINDOW_OUTPUT = (
    RESULTS /
    "laplace_Veff_R1-6_T1-7_t0avg6_correlated_plateau_windows.csv"
)
...
CORRELATION_OUTPUT = (
    RESULTS /
    "laplace_static_potential_R1-6_T3-5_t0avg6_correlation.csv"
)

PLATEAU_FIGURE = (
    FIGURES /
    "laplace_Veff_correlated_plateau_T3-5_t0avg6_R1-6.png"
)

POTENTIAL_FIGURE = (
    FIGURES /
    "laplace_static_potential_correlated_T3-5_t0avg6_R1-6.png"
)
