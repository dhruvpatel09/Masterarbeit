...
inp = Path("results/laplace_clover_probe_R4tau4_axes0-2_t0avg48_n1-100_jk_ratio_summary.csv")
...
ax.set_title(r"Axis-averaged jackknife ratio $\rho_S$, $R/a=4$, $\tau/a=4$, $N_{\rm cfg}=100$")

cbar = fig.colorbar(im, ax=ax)
cbar.set_label(r"$\rho_S = \langle LS\rangle/\langle L\rangle - \langle S\rangle$")

fig.tight_layout()
out = outdir / "laplace_clover_R4tau4_rho_S_heatmap_t0avg48_n100_axisavg_jk_ratio.png"
...
ax.set_title(r"Axis-averaged axial $\rho_S$, $R/a=4$, $\tau/a=4$, $N_{\rm cfg}=100$")
ax.grid(True, alpha=0.3)

fig.tight_layout()
out = outdir / "laplace_clover_R4tau4_rho_S_axis_profile_t0avg48_n100_axisavg_jk_ratio.png"
fig.savefig(out, dpi=300)
plt.close(fig)
print("Wrote", out)
