...
WINDOWS_OUT = (
    RESULTS /
    "laplace_Veff_R1-4_T1-7_t0avg6_correlated_plateau_windows.csv"
)
...
PLATEAU_FIGURE = (
    FIGDIR /
    "laplace_Veff_correlated_plateau_T3-5_t0avg6_R1-4.png"
)

POTENTIAL_FIGURE = (
    FIGDIR /
    "laplace_static_potential_correlated_T3-5_t0avg6.png"
)
...
def main():
    ...
    figure.suptitle(
        "Laplace effective potential (six-source average) and correlated "
        "T/a = 3–5 plateaux"
    )
    ...
    plt.ylabel("a V(R)")
    plt.title(
        "Laplace static potential (six-source average) from correlated "
        "T/a = 3–5 plateaux"
    )
    plt.xticks(R_VALUES)
